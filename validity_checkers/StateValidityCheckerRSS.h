...
public:
	...
	bool isValidRBS(State&, State&, State&, int, int);
	...
	bool checkMotionRBS(State, State, State, State, State, State, State, State, State, int, State, int, int);
	...
	bool reconstructRBS(State, State, State, State, State, State, State, State, State, int, State, Matrix &, int, int, int);
